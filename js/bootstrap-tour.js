jQuery(document).ready(function($) {
    ...
    function createNavigation(steps, n) {
        var tourNavigationHtml = '<div class="cd-nav"><span><b class="cd-actual-step">1</b> z ' + n + '</span><ul class="cd-tour-nav"><li><a href="#0" class="cd-prev">&#171; Wstecz</a></li><li><a href="#0" class="cd-next">Dalej &#187;</a></li></ul></div><a href="#0" class="cd-close">Close</a>';
    ...
    function changeStep(steps, layer, bool) {
        ...
        setTimeout(function() {
            (bool == 'next') ?
            showStep(visibleStep.next(), layer): showStep(visibleStep.prev(), layer);
        }, delay);
    }
